...
<title>NYC - Contact Page</title>
<meta name="keywords" content="Nigerian Youth Congress" />
<meta name="description" content="Contact Us Page of Nigerian Youth Congress">
<meta name="author" content="The Nigerian Youth Congress">
...
<!--<section id="style-customizer">
  <div class="style-customizer-wrap form-horizontal">
    ...
    <br/>
    <br/>
    <div> <a class="sty-demo-btn" href="http://codelayers.net/templates/arma/demo/demo.html" target="_blank">Demos</a> </div>
  </div>
            ...
            <div class="header-inner less-height">
              <div class="overlay">
                <div class="text text-center">
                  ...
                  <h6 class="uppercase text-white sub-title">We are available 24/7</h6>
                </div>
              </div>
            </div>
          </div>
...
<div class="col-md-8">
    	...
    	<form type="POST" id="code-contact" onSubmit="return valid_datas( this );">
          ...
          <div class="col-md-12 text-center">
            ...
            <p>C/o Office of the Senior Special Assistant to the President on Youth and Students Affairs, Phase 1, 5th Floor, Federal Secretariat, Abuja.<br>
                  Telephone: +234 803 713 0976
              </p>
            <br/>
            <p>E-mail: nigerianyouthcongress@gmail.com
            </p>
            <p>Webmail: info@nyc.org.ng</p>
            <ul class="social-icons"><li><a href="#"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
            <li><a href="#"><i class="fa fa-instagram"></i></a></li>
            <li class="last"><a href="#"><i class="fa fa-linkedin"></i></a></li></ul>
          </div>
          <!--end item--> 
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&amp;key=AIzaSyAcjJcWIgmLyfrhWte18ul3Z3Zd89xGYfQ&amp;'%20+%20'callback=GmapInit"></script>  
