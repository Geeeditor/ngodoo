...
<!-- Mirrored from codelayers.net/templates/alpa/page-team-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Mar 2020 08:28:19 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>NYC - Governing Board </title>
<meta name="keywords" content="Nigerian Youth Congress Board Members" />
<meta name="description" content="Nigerian Youth Congress Governing Board">
<meta name="author" content="Nigerian Youth Congress Governing Board">
            ...
            <div class="header-inner less-height">
              <div class="overlay">
                <div class="text text-center">
                  ...
                  <h6 class="uppercase text-white sub-title">Governing Board of Trustees</h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <ol class="breadcrumb">
                ...
                <li><a href="national.php">National Executives</a></li>
                <li class="current"><a href="#">Governing Board</a></li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="#"><h5 class="uppercase raleway less-mar-1 title">Nigerian Youth
</h5></a>
                  <p class="text-primary">Chairman, Governing Board</p>
                  <!--<p class="padding-top-1">Higher National Diploma HND, Public Administration Plateau State Polytechnic, Barkin-Ladi</p>-->
                </div>
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb3.php"><h5 class="uppercase raleway less-mar-1 title">Hon. Nasir Adhama</h5></a>
                  <p class="text-primary">Member, Governinng Board</p>
                  <p class="padding-top-1">Hon. Nasir Sa'idu Adhama, Senior Special Adviser to the President on Youth and Students Affairs.</p>
                </div>
                <div class="overlay"></div>
                <img src="images/g8.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb10.php"><h5 class="uppercase raleway less-mar-1 title">Hon. Isiaka, Ayokunle Ibrahim</h5></a>
                  <p class="text-primary">Member, Governinng Board</p>
                  <p class="padding-top-1">Our dearest erudite and quintessential man with substantial values; Hon. Isiaka Ayokunle Ibrahim; an embodiments </p>
                </div>
                <div class="overlay"></div>
                <img src="images/g15.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb4.php"><h5 class="uppercase raleway less-mar-1 title">Hon. (Barr.) Solomon Selcarp Dalung</h5></a>
                  <p class="text-primary">Member, Governing Board</p>
                  <p class="padding-top-1">Solomon Selcap Dalung is the immediately past Minister of Youth and Sports Development in Nigeria.
</p>
                </div>
                <div class="overlay"></div>
                <img src="images/g3.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb7.php"><h5 class="uppercase raleway less-mar-1 title">Dr. Kalu Ogbureke</h5></a>
                  <p class="text-primary">Member, Governinng Board</p>
                  <p class="padding-top-1">Executive Director Fund, Rural Electricitation Agency of Nigeria.</p>
                </div>
                <div class="overlay"></div>
                <img src="images/g99.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb8.php"><h5 class="uppercase raleway less-mar-1 title">Hon. Princess Omowunmi Olatunji</h5></a>
                  <p class="text-primary">Member, Governing Board</p>
                  <p class="padding-top-1">Hon. Princess Omowunmi Olatunji-Ohwovoriole, Member Governing Board , Nigerian Youth Congress
</p>
                </div>
                <div class="overlay"></div>
                <img src="images/g2.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb6.php"><h5 class="uppercase raleway less-mar-1 title">Dr. Sanusi Ohiare</h5></a>
                  <p class="text-primary">Member, Governinng Board</p>
                  <p class="padding-top-1">Executive Director (Rural Electrication Funds) </p>
                </div>
                <div class="overlay"></div>
                <img src="images/g9.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb11.php"><h5 class="uppercase raleway less-mar-1 title">Hon. Salisu Zakari</h5></a>
                  <p class="text-primary">Member, Governing Board</p>
                  <p class="padding-top-1">Honourable Salisu Zakari Ningi was born on April 4th, 1969 in his hometown of Ningi Town in Ningi Local
</p>
                </div>
                <div class="overlay"></div>
                <img src="images/g13.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb14.php"><h5 class="uppercase raleway less-mar-1 title">Otunba Macjob Gbolahan
</h5></a>
                  <p class="text-primary">Member, Governing Board</p>
                  <p class="padding-top-1">Otunba Gbolahan Macjob is a multimedia journalist for the BBC World Service, London.
</p>
                </div>
                <div class="overlay"></div>
                <img src="images/g14.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
  ...
  <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb9.php"><h5 class="uppercase raleway less-mar-1 title">Architect Sani Abbas
</h5></a>
                  <p class="text-primary">Member, Governing Board</p>
                  <p class="padding-top-1">A young generational Architect with many years of experience in the public sector construction project management,
</p>
                </div>
                <div class="overlay"></div>
                <img src="images/g10.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="gb5.php"><h5 class="uppercase raleway less-mar-1 title">Hon. Babagana Alh. Modu (Bature Goniri)</h5></a>
                  <p class="text-primary">Member, Governinng Board</p>
                  <p class="padding-top-1">Hon. Babagana Alh. Modu (Bature Goniri), Member Governing Board, Nigerian Youth Congress.</p>
                </div>
                <div class="overlay"></div>
                <img src="images/sg18.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
            ...
            <div class="cp-feature-box-1">
              <div class="img-box">
                <div class="text-box">
                  ...
                  <a href="#"><h5 class="uppercase raleway less-mar-1 title">Alh. Garba Muhammad</h5></a>
                  <p class="text-primary">Board Advisory</p>
                  <!--<p class="padding-top-1">Senior Special Adviser to the President on Youth and Student Matters.
</p>-->
                </div>
                <div class="overlay"></div>
                <img src="images/g11.jpg" alt="" class="img-responsive"/> </div>
            </div>
          </div>
          <!--end item-->
    ...
    <section class="sec-padding section-light">
      <div class="container">
        ...
        <!--            </ul>-->
        <!--          </div>-->
        <!--          <a href="gb10.php"><h5 class="uppercase raleway less-mar-1 title">Dr. Tunji John Asaolu</h5></a>-->
        <!--          <p class="text-primary">Member, Governinng Board</p>-->
        <!--          <p class="padding-top-1">Dr. Tunji John Asaolu is currently the Nigerian Representative at the 3rd Permanent General Assembly </p>-->
        <!--        </div>-->
        <!--        <div class="overlay"></div>-->
        <!--        <img src="images/tunji.jpg" alt="" class="img-responsive"/> </div>-->
        <!--    </div>-->
        <!--  </div> -->-->
          <!--end item-->
...
<!-- Mirrored from codelayers.net/templates/alpa/page-team-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Mar 2020 08:28:23 GMT -->
</html>
