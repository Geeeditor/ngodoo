...
<div class="wrapper-boxed">
  <div class="site-wrapper">
    ...
    <h6 class="uppercase text-white sub-title">Welcome to our News Outlines</h6>
    </div>
       </div>       
        </div></div>        
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <ol class="breadcrumb">
                ...
                <li class="current"><a href="#">News Outline</a></li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12 col-xs-12">
            ...
            <img src="images/blog/dem1.jpg" alt="" class="img-responsive"/>
             <div class="text-box no-border"> <p class="text-primary">04 April 2020</p>
              <a href="#"><h5 class="font-weight-5 less-mar-1">COVID-19: NGO commences campaign, distribution of relief material</h5></a>
               <div class="blog-post-info"> <span><i class="fa fa-user"></i> By Admin</span> </div>
               <br/><br/>
               <a class="read-more" href="news-details-youth-distribute-relief-materials.php"> Read more &nbsp; <i class="fa fa-angle-right" aria-hidden="true"></i></a>
               </div>
              <br/>
             </div>
          ...
          <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="ce-feature-box-7 margin-bottom">
            <img src="images/blog/dem.jpg" alt="" class="img-responsive"/>
             <div class="text-box no-border"> <p class="text-primary">30th March 2020</p>
              <a href="#"><h5 class="font-weight-5 less-mar-1">COVID 19: Stay at Home and Stay Safe</h5></a>
               <div class="blog-post-info"> <span><i class="fa fa-user"></i> By Admin</span> <span><i class="fa fa-comments-o"></i> 15 Comments</span> </div>
               <br/><br/>
               <a class="read-more" href="news-details.php"> Read more &nbsp; <i class="fa fa-angle-right" aria-hidden="true"></i></a>
               </div>
              <br/>
             </div>
