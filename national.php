...
<title>NYC - National Executives </title>
<meta name="keywords" content="NYC National Executives" />
<meta name="description" content="Welcome to Nigerian Youth Congress National Executive Page">
<meta name="author" content="Welcome to Nigerian Youth Congress National Executive Page">
...
<link rel="stylesheet" href="css/hairsaloon.html" type="text/css">
<link rel="stylesheet" href="css/band.html" type="text/css">
<link rel="stylesheet" href="css/barber.html" type="text/css">
            ...
            <div class="header-inner less-height">
              <div class="overlay">
                <div class="text text-center">
                  <h3 class="uppercase text-white less-mar-1 title">Nigerian Youth Congress</h3>
                  <h6 class="uppercase text-white sub-title">National Executives</h6>
                </div>
              </div>
            </div>
          </div>
    ...
    <section>
      <div class="pagenation-holder">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <h4>National Executive</h4>
            </div>
            <div class="col-md-6">
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">State Executives/a></li>
                <li class="current"><a href="#">National Executives</a></li>
              </ol>
            </div>
          </div>
        </div>
...
<section class="sec-padding section-dark-4">
  <div class="container">
  <div class="row">
          ...
          <!--<div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Secretary General, National Youth Council of Nigeria. </p>
                    <br/>
                    <ul class="sc-icons">
                  ...
                  <img src="images/n1.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <a href="about-gb4.php"><h5 class="nopadding title">Blessing A. Akinlosotu</h5></a>
                  <p class="subtext">President, NYC</p>
                </div>
              </div>
            </div>
            <!-end feature box-> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Blessing A. Akinlosotu, President, Nigerian Youth Congress.</p>
                    <br/>
                      <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  ...
                  <img src="images/n.jpg" alt="" class="img-responsive"/> 
                </div>
               <div class="text-box text-center">
                  <h5 class="nopadding title">Comr. Blessing A. Akinlosotu</h5>
                <a href="about-gb4.php"> <p class="subtext">President</p></a> 
                </div>
               </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Aysha Ahmad is a unique and beautiful legal practitioner, a Philanthropist </p>
                  ...
                  <img src="images/n20.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Barr. Aysha Ahmad Mohammad</h5>
                  <a href="ne20.php"><p class="subtext">Deputy President</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
       ...
       <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">THE MAN WITH THE MIDAS TOUCH COMRADE OGUNSOLA GBENGA, OUT GONE CHAIRMAN, NATIONAL YOUTH COUNCIL OF NIGERIA</p>
                  ...
                  <img src="images/n2.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Comr. Ogunsola E. Gbenga</h5>
                  <a href="ne12.php"><p class="subtext">Vice President South West</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Barr. Maxwell Chidiebere Ezelagu is a native of Umulibe Abia-Omuma, Omuma, Oru-East Local Government of Imo State </p>
                    <br/>
                    <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  ...
                  <img src="images/n19.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Barr. Maxwell C. Ezelagu</h5>
                 <a href="ne19.php"> <p class="subtext">Vice President South East</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
            ...
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  ...
                  <img src="images/nig.jpg" alt="" class="img-responsive"/> 
                </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Vice President South South</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">The Son of well known Arabic Scholar, Late Mal. Abubakar Zauro. He was an active and influential scholar throughout his life</p>
                    <br/>
                    <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  ...
                  <img src="images/n22.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Comr. Shafiu Abubakar Zauro</h5>
                  <a href="ne22.php"><p class="subtext">Vice President North West</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
       ...
       <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">MOHAMMED SUHAILU ABUBAKAR, an indigene of Gombe state from Akko Local Govt, he attended Muazu Primary School in Gombe state </p>
                  ...
                  <img src="images/n16.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Comr. Mohammed Suhailu Abubakar</h5>
                <a href="ne88.php">  <p class="subtext">Vice President North East</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Award winning Stephen Abraham Narai hold Bachelor of Mathematics and Computer Science from Federal University of Technology</p>
                    <br/>
                    <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  ...
                  <img src="images/n21.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Comr, Stephen Abraham Narai,</h5>
                  <a href="ne10.php"><p class="subtext">Vice President North Central</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Dr. Raymond Edoh, a researcher, tutor, economist and financial consultant.</p>
                    <br/>
                      <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Dr. Raymond Edoh</h5>
                  <a href="ne.php"><p class="subtext">Secretary-General</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
            ...
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  ...
                  <img src="images/nig.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                 <a href="#"> <p class="subtext">Assistant Secretary-General</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
       ...
       <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Prince (Comr.) Victor Alobari Dumbari, Publicity Secretary of Nigerian Youth Congress.</p>
                    <br/>
                    <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  ...
                  <img src="images/n8.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Prince Victor Alobari D.</h5>
                  <a href="ne7.php"><p class="subtext">Publicity Secretary</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Assistant Publicity Secretary</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                 <a href="#"> <p class="subtext">Treasurer</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                 <a href="#"> <p class="subtext">Financial Secretary</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
       ...
       <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Legal Adviser</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <a href="#"><p class="subtext">Diaspora Affairs Officer</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
...
<section class="sec-padding section-dark-4">
  ...
  <div class="row">
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Adekunbi Olorode is an entrepreneur with vast experience in business and a Health Care Worker with the NHS United Kingdom </p>
                    <br/>
                      <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Comr. Adekunbi Olorode</h5>
                 <a href="ne8.php"><p class="subtext">Social Secretary</p></a> 
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Internal Auditor</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
       ...
       <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <a href="#"><p class="subtext">Programme Officer</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Coordinator of Person With Disabilities</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
    ...
    <div class="clearfix"></div>
    <!-- end section --><section class="sec-padding section-dark-4">
  <div class="container">
  <div class="row">
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Organizing Secretary South West</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Organizing Secretary South East</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
       ...
       <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Organizing Secretary South South</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Shafaatu Salihu Labbo, contested in the 2019 General Election for the Member State House of Assembly.</p>
                    <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                  ...
                  <img src="images/n17.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Shafaatu Salihu Labbo</h5>
                 <a href="ne11.php"> <p class="subtext">Organizing Secretary North West</p></a>
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Organizing Secretary North East</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
         ...
         <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                ...
                <div class="text-box text-center">
                  <h5 class="nopadding title">Nigerian Youth</h5>
                  <p class="subtext">Organizing Secretary North Central</p>
                </div>
              </div>
            </div>
            <!--end feature box--> 
   ...
   <!--   <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom">
            <div class="ce-feature-box-6">
              <div class="main-box">
                <div class="img-box">
                  <div class="overlay">
                    <p class="small-text text-center">Dr. Tunji John Asaolu is currently the Nigerian Representative at the 3rd Permanent General Assembly of the African Union Economic </p>
                    <br/>
                    <ul class="sc-icons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  ...
                  <img src="images/n18.jpg" alt="" class="img-responsive"/> </div>
                <div class="text-box text-center">
                  <h5 class="nopadding title">Dr. Tunji Asaolu</h5>
                 <a href="gb10.php"> <p class="subtext">Technical Advicer</p></a>
                </div>
              </div>
            </div> -->
            <!--end feature box--> 
...
<li><a href="#"><i class="fa fa-angle-right"></i> Ward Coordinators</a></li>
    ...
    <div class="clearfix"></div><!--end wrapper boxed--> 
