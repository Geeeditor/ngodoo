...
<!-- Mirrored from codelayers.net/templates/alpa/blog-3-columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Mar 2020 08:30:23 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>NYC - News Highlight </title>
<meta name="keywords" content="Nigerian Youth Congress News Highlight" />
<meta name="description" content="Nigerian Youth Congress News Highlight">
<meta name="author" content="Nigerian Youth Congress News Highlight">
...
<link rel="stylesheet" href="css/blog2.html" type="text/css">
...
<div class="wrapper-boxed">
  <div class="site-wrapper">
    ...
    <h3 class="uppercase text-white less-mar-1 title">NYC NEWS</h3>
    <h6 class="uppercase text-white sub-title">Welcome to News Details</h6>
    </div>
       </div>       
        </div></div>        
        </div>
    ...
    <section>
      <div class="pagenation-holder">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
             <h4 class="uppercase">News Update</h4>
            </div>
            <div class="col-md-6">
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="about.php">About Us</a></li>
                <li class="current"><a href="#">News Details</a></li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section class="sec-padding section-light section-bgimg-12">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="cb-feature-box-1">
              <div class="img-box">
                <img src="images/blog/dem1.jpg" alt="" class="img-responsive"/> </div>
              <div class="postinfo-box">
                <h4 class="uppercase title less-mar-1"><a href="#">Nigerian Youth Congress</a></h4>
                
                 <h6 class="uppercase title text-primary less-mar-1"><a href="#">COVID-19: NGO commences campaign, distribution of relief materials</a></h6>
                 <!--<h6 class="uppercase title"><a href="#">124,658 Followers</a></h6>-->
                
                <br/>
                <p align="justify">The Nigerian Youth Congress, coordinating body of Youth groups and Organizations in the Federal Republic of Nigeria has commenced the distribution of Hand Sanitizers and Relief Materials, through the office of the Senior Special Adviser to the President on Youth and Students Affairs and Senator Andy Uba Foundation, across the six geopolitical zones of the country.</p>

<p align="justify">In line with its mandate of Community Service and Social Outreach, the coordinating Youth Body commence the distribution of Medical and Relief Materials to complement the efforts of the Federal Government through the Federal Ministry of Health, Federal Ministry of Humanitarian Affairs, Disaster Management and Social Development and Nigeria Centre for Disease Control to Nigerians and it is expected to go round the country in combating the spread of the deadly Novel CoronaVirus (COVID 19) within the country. </p>

<p align="justify">Declaring the event open, the Chairman of the Governing Board of Nigerian Youth Congress, Dr. Yakubu Shendam alongside the President of Nigerian Youth Congress, Comrade Blessing Akinlosotu call on Nigerians not to panic but follow all the laid down precautions and safety procedures by the Federal Ministry of Health and Nigeria Centre for Disease Control at this critical time that the country and the world is facing a difficult health challenge.</p>

<p align="justify">The NYC is partnering with the Andy Uba Foundation and Nigerian Youth Taskforce on COVID 19 for the nationwide execution and implementation of this laudable initiative.</p>

<p align="justify">The distribution which was launched yesterday in Anambra State is expected to go round the six geopolitical zones of the country.</p>

<p align="justify">The Chairman, Governing Board noted that the coordinating Youth body is battle-ready to support the Federal Government of Nigeria to stop the spread of the deadly virus and reiterated the commitment of the Governing Board to support the initiative of the distribution of the materials. </p>

<p align="justify">In his speech, the President, Blessing Akinlosotu thanked all the volunteers who are willing to support for proper distribution of the entire materials to the masses of Nigerian. He used the medium to appreciate the donor, Senator Andy Uba Foundation and also urge many other well-meaning Nigerians to support the initiatives of the organization with more materials for the benefit of the entire citizens in other to defeat the deadly virus.</p>
</p>
                <br/>
                <br/>
                <!--<a class="btn btn-dark-3 btn-large uppercase" href="#">Follow Author</a>--> </div>
            </div>
            <!--end post item-->
            <div class="clearfix"></div>
            <br/>
          ...
          <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="ce-feature-box-7 margin-bottom">
            <img src="images/blog/3.jpg" alt="" class="img-responsive"/>
             <div class="text-box no-border"> <p class="text-primary">22 August 2019</p>
...
<!-- Mirrored from codelayers.net/templates/alpa/blog-default-author.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Mar 2020 08:30:24 GMT -->
</html>
